...
st.set_page_config(page_title="ACC Setup Master v9.5", layout="wide")

# 2. DATABASE: Volledige geometrie per auto
cars_db = {
...
# 3. SELECTIE
st.title("🏎️ ACC Setup Master v9.5")
...
ukey = f"v95_{auto}_{circuit}".replace(" ", "_").replace("-", "")
