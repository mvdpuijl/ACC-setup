...
st.set_page_config(page_title="ACC Setup Master v9.48", layout="wide")

# Styling: EXACTE v9.40 Grayscale Stealth (Geen Rood)
st.markdown("""<style>
    ...
    /* Algemene knoppen */
    .stButton>button { border: 1px solid #444; background-color: #000; color: #fff; }
    .stButton>button:hover { border-color: #fff; color: #fff; }
</style>""", unsafe_allow_html=True)

# 2. CORE DATABASE (Full DNA)
cars_db = {
